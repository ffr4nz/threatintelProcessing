...
public class InsertMongoDB extends RichFlatMapFunction<Tuple2<String, HashMap>, Tuple2<String, HashMap>> {

    private String Status;
    private String Collection;
    private String Database;

    public InsertMongoDB(String status, String collection, String database) {
        Status = status;
